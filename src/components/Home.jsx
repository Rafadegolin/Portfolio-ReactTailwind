  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className='text-[#8992b0] py-4 max-w-[700px] text-justify'>Sou um desenvolvedor full stack, com mais especialidade em Front-end com ReactJS e design, conhecedor
